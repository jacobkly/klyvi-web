 ...
 * spec. The recharts `chart` component installs when live per-genre and
 * per-year data lands; these two distributions are computable honestly from
 * the tracking list alone, so nothing here is invented.
 */
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10 md:px-6">
      ...
      <p className="mt-12 text-xs text-muted-foreground">
        Genres, keywords, and years arrive with the live catalog, so nothing
        here has to be made up.
      </p>
    </main>
  );
}
